  ...
  return (
    <main className="main-shell space-y-12">
      ...
      >
        ...
        <p className="mt-4 text-sm md:text-base text-gray-300 max-w-3xl">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          />
          <div className="section-card p-4 bg-white/5">
        ...
        <div className="section-card p-6 space-y-4">
          ...
          <div className="grid gap-3 text-sm text-gray-300">
            {[
              ...
              <div key={item} className="rounded-xl border border-white/10 bg-white/5 p-3 flex items-center gap-3">
